...
<section class="content font-weight-bold">
	<div class="row">
		<div class="col-md-12">
			<div class="card" id="invoice">
				...
				<div class="card-body">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<table style="color: black !important; font-size: 18px" class="table table-bordered font-weight-bold bg-white text-center" >
									<thead >
										<tr>
											<th>Roll No</th>
											<th>Post Name</th>
						...
						<p></p>
						<div class="row font-weight-bold" style="font-size: 16px !important">
							<div class="col-md-12">
...
<script src="../../plugins/HtmltoPDF/html2canvas.min.js"></script>
<script src="../../plugins/HtmltoPDF/pdfmake.min.js"></script>
<script>
window.onload=function(){
	html2canvas($('#invoice')[0], {
		onrendered: function (canvas) {
			...
			pdfMake.createPdf(docDefinition).download("Roll Number Slip.pdf");
		}
	});
	// setTimeout(function(){
