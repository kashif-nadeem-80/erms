            ...
            <div class="card-title"> </div>
              ...
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="password" name="oldPass" class="form-control" placeholder="Old Password" id="pass" onchange="ajaxCall()" required>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <center><input id="save" type="submit" style="width:225px ;" class="btn btn-success" name="update" value="Change"></center>
                    </div>
                  </div>
                </form>
                <?php
                  if(isset($_POST['update']))
                  {
                    ...
                    if($userPaswsord == $oldPass)
                    {
                      ...
                      {
                        $updatePass = "UPDATE candidates SET password = '$newPass' WHERE id = '$canddate_id'";
                        ...
                        echo "<!DOCTYPE html>
                         ...
                         echo "<!DOCTYPE html>
                          <html>
                            ...
                            Swal.fire(
                              'Error !',
                              'Password not change, some error occure',
                              'error'
                            ).then((result) => {
                              if (result.isConfirmed) {
                                 window.location.href = 'change_password.php';
