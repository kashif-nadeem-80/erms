  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        ...
        <a href="post_apply.php?id=<?php echo $proj_id ?>" class="btn btn-warning mt-3">Back</a>
      </div>
      <div class="col-md-6">
                  ...
                  <div class="col-md-12 table-responsive">
                    ...
                    <table class="table table-striped table-bordered bg-white text-center"
                      ...
                      <thead class="bg-dark">
                        ...
                        LEFT JOIN projects_posts AS pp ON pp.id= cap.post_id WHERE cap.id = '$apply_id'";
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  if($disability == 'Yes')
                  { ?>
                  <a href="#edit" class="ajaxData1" data-toggle='modal'
                    data-id="<?php echo $disable_file ?>">(View)
                  </a>
                  <?php } ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  ?>
                  <a href="#edit" class="ajaxData2" data-toggle='modal'
                    data-id="<?php echo $widow_file ?>">(View)
                  </a>
                  <?php }?>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        ?>
                        <a class="Data_Ajax3" data-id="<?php echo $pathImg ?>" href="#edit"
                          data-toggle='modal'>
                          View
                        </a>
                        <?php } ?>
