...
$projId_enc = base64_encode($projId);
?>
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="m-0 text-dark">Online Apply for Post</h4>
      </div>
      <div class="col-md-6">
    ...
    <div class="col-md-12">
      ...
      <div class="card shadow card-dark">
        <div class="card-header">
          <div class="card-title">Online Apply</div>
        </div>
        <div class="card-body">
          <form method="post">
            <div class="row">
              <div class="col-md-12">
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    <td>B. Do you have requiste Qualification & Experience as mentioned in</
                    Advertisment</td>
                    <td>
                ...
                <span class="text-danger">If your reply is "Yes" to A, B & C above, only then please
                proceed further.Otherwise you are not eligible to apply.</span>
              </div>
            </div>
            <br>
            <br>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="text-justify">
                  ...
                  application form and all the additional particulars / documents / certificates
                  furnished along with it are true to the best of my knowledge and belief and nothing
                  has been concealed.I also declare that I have never been dismissed or removed from
                  GOVT.service under any provincial,federal governament autonomous and semi-autonomous
                  or state enterprise. if any wrong or incorrect is found later,I shall be liable to
                  any disciplinary action which may result in cancellation of my candidatur and even
                  my employement.
                </p>
                <input type="checkbox" id="agree" style="height: 20px; width: 20px"
                onchange="undertaking()"> <b>I Have Agree</b>
              </div>
            </div>
            <br>
            <div class="row">
          ...
          <html>
            <body>
              ...
              Swal.fire(
              'Added !',
              'Post Apply has been added Successfully',
              'success'
              ).then((result) => {
...
function showDiv() {
  ...
  if (check1 != '0' && check2 != '0' && check3 != '0' && $('#agree').is(":checked")) {
...
function undertaking() {
  if ($('#agree').is(":checked") && $('#test0').val() != '0' && $('#test1').val() != '0' && $('#test2').val() != '0') {
