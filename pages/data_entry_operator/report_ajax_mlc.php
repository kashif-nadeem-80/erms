          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" name="dob" id="d_o_b1" class="form-control" disabled value="<?php echo $dob; ?>">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>Age</label>
                <input type="text" placeholder="Age" id="agee1" class="form-control" disabled>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
...
<script type="text/javascript">
  ...
  function getAge()
  {
    ...
    $("#agee1").val(year_age + " years & " + month_age + " months");
  }
