...
<section class="content">
  <div class="container-fluid" class="text-center">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-dark" class="text-center">
          ...
          <div class="card-body">
            <?php
              $query2 = "SELECT  e.id,e.passing_year,e.major_subject, e.obtain_marks, e.total_marks, e.university, e.percentage, e.division, e.deg_image, d.deg_name, ed.level_name FROM education AS e JOIN degree AS d ON d.id = e.degree_id LEFT JOIN edu_level AS ed ON ed.id = d.level_id WHERE e.candi_id= '$u_id' ORDER BY e.id ASC";
                ...
                <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-right">
                      <input type="submit" class="btn btn-success shadow" value="Add" name="saveUser1">
                    </div>
                  </div>
                </form>
              </div>
    ...
    if(isset($_POST['saveUser1']) OR isset($_POST['saveUser2']))
    {
      ...
      $query1 = "INSERT INTO `education`(`candi_id`, `degree_id`, `passing_year`, `obtain_marks`, `major_subject`, `total_marks`, `university`, `deg_image`, `percentage`, `division`) VALUES ('$u_id', '$degree', '$pass_year', '$obtained_marks', ' $major_subject','$total_marks','$university','$certImage','$edu_percent','$edu_division')";
            ...
            <html>
              ...
              Swal.fire(
                ...
                if (result.isConfirmed) {
                  window.location.href = 'registered_add_education.php?u_id=$u_id';
                }
              });
              </script>
              </body>
...
<script>
  ...
  $.ajax({
  method: 'POST',
  url: '../candidates/candidate_ajax.php',
  data: {
