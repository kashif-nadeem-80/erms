...
<section class="content">
	<div class="container-fluid">
		<div class="row">
			...
			$profImage = date("Y-m-d H-i-s").$_FILES['logo1']['name'];
				...
				$query1 = "INSERT INTO `work_experince`(`company`, `job_title`, `date_from`, `date_to`, `file`, `candidate_id`, `payment`, `total_exp`) VALUES ('$company1','$job1','$date_from1','$date_to1','$profImage', '$u_id', '$exp_payment1', '$exp_total1')";
			...
			<html>
					...
					window.location.href = 'registered_add_experience.php?u_id=$u_id';
					}
					});
					</script>
				</body>
	...
	$.ajax({
	method: 'POST',
	url: '../candidates/employement_experince_ajax.php',
	data: {
