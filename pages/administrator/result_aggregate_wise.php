...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="m-0 text-dark">Candidates Result (Aggregate Wise)</h4>
      </div>
      <div class="col-md-6">
...
<section class="content" style="overflow-x: hidden;">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label>No. of top Candidates (Aggregate Wise)</label>
    ...
    <div class="row printBlock">
      <div class="col-md-12">
        <div class="form-group text-right">
          ...
          <button class="btn btn-danger shadow" onclick="window.location.href = 'result_aggregate_wise.php'">Close</button>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  function getPost()
  {
    ...
    $.ajax({
      method:'POST',
      url:'result_aggregate_wise_ajax.php',
      data: {
          projId: projId
      },
      dataType: "html",
