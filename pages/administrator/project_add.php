              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="title" placeholder="Project Title" required></textarea>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Project Id <span class="text-danger">*</span></label>
                    <input type="text" name="proj_id" placeholder="Project Id" class="form-control" autocomplete="off" required>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="file" accept="application/pdf" id="advertisement" class="form-control" name="addver" onchange="showImage1(event);">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Upload Application Form (PDF)</label>
                    <input type="file" accept="application/pdf" class="form-control" name="app_form" onchange="showImage2(event);" id="app_form">
                  </div>
                </div>
              </div>
              <div class="row">
