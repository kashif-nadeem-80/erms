 ...
 <section class="content printClr">
  ...
  <div class="container-fluid">
    <div class="border border-dark invoice sizet">
      <div class="row">
        <div class="col-md-4">
          <img class="ml-2 mt-2" width="300px" height="70px" src="../../images/uts-logo.png" alt="uts">
        </div>
        <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-md-12">
          <p class="text-danger text-right mr-1 ml-1" style="font-family: time new roman;">اپنی رقم ہمیشہ کاؤنٹر پر جمع کروائیں اور ڈپازٹ سلپ پر فلیٹ ہیڈ پرنٹر سے الیکٹرونک رسید حاصل کریں کاؤٹر چھوڑنے سے پہلے اس الیکٹرونک رسید مکمل کوائف بع رقم اور اکاؤنٹ نمبر چیک کرلیں بصورت دیگر بینک ذمہ دار نہ ہوگا</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
    ...
    <div class="border border-dark invoice">
      ...
      <div class="row">
        <div class="col-md-12">
          <p class="text-danger text-right mr-1 ml-1" style="font-family: time new roman;">نوٹ : برائی مہربانی فیس صرف ایک بینک میں جمع کروائیں.اور اس بینک کے دیۓ ہوۓ باکس پر نشان لگائیں۔</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
