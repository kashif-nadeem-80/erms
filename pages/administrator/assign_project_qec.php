...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="m-0 text-dark">Assiging Posts To QEC Operators</h4>
      </div>
      <div class="col-md-6">
  ...
  <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            <label>Select QEC Operator</label>
            <select class="form-control select2" name="op_id" required>
              <option value="">Choose</option>
              <?php
              $fetchData = "SELECT * FROM management_users WHERE role_id = '5' AND status = '1'";
    ...
    <?php
      if(isset($_POST['save']))
      {
        $postId = $_POST['post'];
        $op_id = $_POST['op_id'];
        $fetch = "SELECT id FROM project_to_operator WHERE post_id = '$postId' AND operator_id = '$op_id' AND (operator_type = 'qec')";
            ...
            <html>
              ...
              Swal.fire(
                ...
                if (result.isConfirmed) {
                   window.location.href = 'assign_project_qec.php';
                }
              });
              </script>
              </body>
        ...
        {
          $fetch2 = "SELECT id FROM project_to_operator WHERE operator_id = '$op_id' AND status = '1' AND (operator_type = 'qec')";
          ...
          {
            $insert = "INSERT INTO `project_to_operator`(`post_id`, `operator_id`, `operator_type`) VALUES('$postId', '$op_id', 'qec')";
    ...
    <div class="row">
      <div class="col-md-12">
        <table class="table table-hover table-bordered datatable" style="font-size: 12px" data-page-length = "100">
          ...
          <?php 
          $count = 0;
          $fetchData= "SELECT u.name, p.post_name, u.id AS operatorid, p.post_bps, o.id, o.status, pj.project_name FROM management_users AS u INNER JOIN project_to_operator AS o ON o.operator_id = u.id INNER JOIN projects_posts AS p ON p.id = o.post_id INNER JOIN projects AS pj ON pj.id = p.project_id WHERE o.operator_type = 'qec' ORDER BY pj.id DESC, u.name ASC";
...
<script type="text/javascript">
  function Data_Ajax(id) {
    ...
    $.ajax({
      method: 'POST',
      url: 'assign_project_qec_ajax.php',
      data: {
  ...
  function deleteData(id)
  {
    var data_id = id;
      ...
      if (result.isConfirmed) {
        window.location.href= "assign_project_qec.php?deletId="+data_id;
      }
  });
...
<?php
  if(isset($_POST['updateStatus']))
  {
    ...
    {
      $fetch3 = "SELECT id FROM project_to_operator WHERE operator_id = '$operatrid' AND status = '1' AND (operator_type = 'qec')";
