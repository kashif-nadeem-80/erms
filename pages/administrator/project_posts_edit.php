...
<section class="content">
    <div class="container">
        <div class="row printBlock">
            <div class="col-md-12">
                <a href="project_posts.php?proj_id=<?php echo $proj_id ?>" class="btn btn-warning shadow mb-3">Back</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <?php
            $fetch1 = "SELECT pp.id,pp.project_id,pp.post_name,pp.post_bps,pp.no_of_posts,pp.age_lower,pp.age_upper,pc.challan_title,pc.id AS c_id FROM projects_posts AS pp LEFT JOIN projects_challans AS pc ON pc.id = pp.proj_challan_id WHERE pp.id = '$challan_id'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_of_posts" placeholder="No of Posts"
                                            class="form-control" value="<?php echo $no_of_posts ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                  ...
                  echo "<!DOCTYPE html>
                    <html>
                      ...
                      Swal.fire(
                        ...
                        if (result.isConfirmed) {
                           window.location.href = 'project_posts_edit.php?challan_id=$challan_id';
                        }
                      });
                      </script>
                      </body>
