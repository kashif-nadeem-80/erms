    ...
    <div class="row printBlock">
      <div class="col-md-12">
        <div class="form-group text-right">
          <button type="button" class="btn btn-info shadow" onclick="export_all_data()">Export To CSV</button>
...
<script type="text/javascript">
  function getPost()
  {
    ...
    $.ajax({
      method:'POST',
      url:'report_accept_reject_ajax.php',
      data: {
          projId: projId
      },
      dataType: "html",
  ...
  function export_all_data() {
      ...
      window.open('report_accept_reject_download.php?proj_id='+proj_id+'&post_id='+post_id+'&type='+list_type);
  }
