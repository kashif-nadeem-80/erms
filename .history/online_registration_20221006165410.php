        ...
        <div class="container" >
          <div class="card">
            <div class="card-body" >
              ...
              <p  style="margin-top: -10px; margin-bottom: 20px">Have an account Or <a href="#" class="btn  badge-pill badge-success shadow h-100" style="font-size:large; font-weight:bold ;" onclick="registDiv()"> Register Here </a> </p> 
