      ...
      <td>
        ...
        <?php
          ...
          else
          {
            ...
            echo '<a href="#image_view" data-toggle="modal" onclick="challan_view('.$count.')"><img id="log1" class="shadow" style="border: 1px blue solid; border-radius: 5px;" width="90px;" height="90px"  src="'.$path_challan.'" alt="Challan Image"></a>';
