			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-12 table-responsive">
						<!-- <table class="table table-striped table-bordered datatable bg-white text-center" style="font-size: 12px" > -->
						<table class="table table-striped table-bordered  bg-white text-center" style="font-size: 12px" >
							...
							<tbody>
								...
								$query = "SELECT c.id AS cand_id, ac.roll_no,c.name,c.f_name,c.gender,c.cnic,c.image,
                                    ...
                                    WHERE ac.roll_no != '0' AND pr.status = '1' and c.cnic = '$cnic_app'";
