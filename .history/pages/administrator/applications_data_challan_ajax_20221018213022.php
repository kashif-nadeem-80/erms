  ...
  <tbody>
    <?php
      ...
      while ($rowQ = mysqli_fetch_array($runQ)) {
        ...
        $f_name = $rowQ['f_name'];
        // $path = "../../images/candidates/profile picture/".$rowQ['image'];
        $path_challan = "../../images/candidates/profile picture/".$rowQ['challan_file'];
        $gender = $rowQ['gender'];
        $cnic = $rowQ['cnic'];
        $phone = $rowQ['phone'];
        $c_name = $rowQ['c_name'];
    ...
    <tr>
      ...
      <td>
        ...
        <?php
          ...
          {
            echo '<a href="#image_view" data-toggle="modal" onclick="pic_view('.$count.')"><img id="log1" class="shadow" style="border: 1px blue solid; border-radius: 5px;" width="60px;" height="60px"  src="'.$path_challan.'" alt="Candidate Image"></a>';
          } 
          ?>
      </td>
      <!-- <td class="printBlock">
