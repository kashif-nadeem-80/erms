...
<table  class="table table-hover datatable bg-white table-responsive"  style="font-size: 11px" data-page-length="100">
  <thead class="bg-dark printColor">
    <tr>
      ...
      <th>Status Details</th> -->
      <th>Thumbnail</th>
      <th class="printBlock">Full Image</th>
    </tr>
  </thead>
  <tbody>
    <?php
    ...
    <tr>
      ...
      <td>
        ...
        <?php
          ...
          {
            echo '<a href="#image_view" data-toggle="modal" onclick="pic_view('.$count.')"><img id="log1" class="shadow" style="border: 1px blue solid; border-radius: 5px;" width="60px;" height="60px"  src="'.$path.'" alt="Challan Image"></a>';
            echo '<a href="#image_view" data-toggle="modal" onclick="challan_view('.$count.')"><img id="log1" class="shadow" style="border: 1px blue solid; border-radius: 5px;" width="60px;" height="60px"  src="'.$path_challan.'" alt="Challan Image"></a>';
