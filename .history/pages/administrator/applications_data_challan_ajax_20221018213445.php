      ...
      <td>
        ...
        <?php
          ...
          else
          {
            ...
            echo ' <a style="margin-top: 2px" onclick="challan_view(<?php echo $count ?>)" href="#edit" data-toggle='modal' title="View Challan" class="btn btn-sm btn-info title shadow"><i class="fa fa-receipt"></i></a> '
          } 
          ?>
      </td>
      <!-- <td class="printBlock">
