...
<section class="content">
  ...
  <div class="container-fluid">
    ...
    <h2></h2> 
    <p> <span style="font-size:xx-large ; font-weight:bolder; padding-right: 680px;"> 
    Administration Dashboard </span> <span  style="align-items:center ;">  
             <a href="applications_status.php" style="width:150px ; align-items: center;" class="btn  badge-pill badge-success shadow" >Change Test City</a>  
            </span> </p> 
              ...
              <div class="inner">
                ...
                <h3>
                  ...
                  <?php
                    ...
                    $query = "SELECT * FROM candidate_applied_post";
              ...
              <div class="inner">
                ...
                <h3>
                  ...
                  <?php
                    ...
                    $query = "SELECT * FROM candidate_applied_post WHERE challan_file != ''";
