...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="m-0 text-dark">Serach Applicant Roll No Slip</h4>
      </div>
      <div class="col-md-6">
...
<section class="content" style="overflow-x: hidden;">
  ...
  <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="cnic" id="cnic" onchange="getApplicantData()" data-inputmask="'mask': '99999-9999999-9'"
             placeholder="XXXXX-XXXXXXX-X" maxlenght="15" class="form-control"
             autocomplete="off" style="width:fit-content ;"  >
