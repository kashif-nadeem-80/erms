    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-dark" class="text-center">
          ...
          $emp_type = $rowData['posting'];
          $emp_project = $rowData['posting'];
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="emp_type" class="form-control" required>
                      <?php if($employeement == NULL OR $emp_type == '') {
                      echo "<option value=''>Choose</option>";
                      } else {
                      echo "<option value='$employeement'>$employeement</option>"; }
                      ?>
...
<?php
          ...
          if(isset($_POST['saveUser1']) OR isset($_POST['saveUser2']))
          {
            ...
            `marital_status` = '$u_marital_status',`disability`='$u_disability', 
             ...
             bps='$u_bps', project='$u_emp_project' , emp_type ='$u_emp_type'
              WHERE cnic = '$canddate_id'" ;
