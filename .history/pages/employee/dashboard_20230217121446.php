        ...
        <div class="card " >
            <div class="card-body   ">
                <div class="row">
                    ...
                    <a href="personal_information.php?id=<?php echo $proj_id ?>" class="btn btn-warning mt-3">click to Update your Bio Data</a>
        ...
        <div class="card">
            <div class="card-body ">
                <div class="row">
                    ...
                    <p> <span style="font-size:x-large ; font-weight:bolder; color: black;"> Status </span>  </p>
                  ...
                  $count = 0;
      // echo "this test line";
      $query2 = " select * from employee e where e.id= '$candd_id' ";
