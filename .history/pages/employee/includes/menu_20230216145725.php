...
<aside class="main-sidebar sidebar-dark-primary elevation-3" style="background-color:rgb(35,100, 130);">
  <!-- Brand Logo -->
  <!-- Sidebar -->
  <div class="sidebar ">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="info ml-5">
        <a href="dashboard.php">
          <img src="../../images/logo.png" style="width: 80px; height: 80px; border-radius: 30px;">
        </a>
      </div>
    </div>
    <!-- Sidebar Menu -->
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="dependent_information.php" class="nav-link <?php if($curPageName == 'dependent_information.php') echo "active" ?>">
 ...
 <li class="nav-item">
 <a href="employee_full_info.php?apply_id=<?php echo $canddate_id ?>&proj_id=<?php echo "33" ?>" 
 class="nav-link <?php if($curPageName == 'employee_full_info.php') echo "active" ?> " > 
  <i class="nav-icon fa fa-scroll"></i>
            <p>
             View Full Info
            </p>
