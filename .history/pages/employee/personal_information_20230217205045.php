    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-dark" class="text-center">
          ...
          from employees e 
          left outer join districts d on e.domicile =  d.district_id and 
          left outer join designation ds on d.desig_code = e.designation 
          ...
          $emp_project = $rowData['emp_project'];
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="designation" class="form-control select" required>
                      <option value="<?php echo $designation_id ?>"><?php echo $designation ?></option>
                      <?php
                      $data = "SELECT  desig_code, name FROM designation ORDER BY name ASC";
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="emp_type" class="form-control" required>
                      <?php if($emp_type == NULL OR $emp_type == '') {
                      echo "<option value=''>Choose</option>";
                      } else {
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Project</label>
                    <select name="emp_project" class="form-control" required>
                      <?php if($emp_project == NULL OR $emp_project == '') {
                      echo "<option value=''>Choose</option>";
                      } else {
                      echo "<option value='$emp_project'>$emp_project</option>"; }
                      ?>
                      ...
                      <option value="SH">Shelter-Home</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    max="<?php echo date('Y-m-d')?>"  value="<?php echo  $doa;?>" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="domicile" class="form-control select2" required>
                      ...
                      <?php
                      $data = "SELECT distinct district, district_id FROM districts ORDER BY district ASC";
                      $run = mysqli_query($connection,$data);
                      while ($row = mysqli_fetch_array($run)) {
                      $id = $row['district_id'];
                      $name = $row['district'];
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    placeholder="Insert Your Image" required>
                  </div>
...
<?php
          ...
          if(isset($_POST['saveUser1']) OR isset($_POST['saveUser2']))
          {
            ...
            $u_emp_project= $_POST['emp_project'];
            $u_emp_type= $_POST['emp_type'];
            ...
            `marital_status` = '$u_marital_status',`disability`='$u_disability', 
             ...
             bps='$u_bps', project='$u_emp_project' , emp_type ='$u_emp_type', doa='$u_doa'
              WHERE cnic = '$canddate_id'" ;
