          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <select name="city" disabled class="form-control select2" required>
                    ...
                    <option value="<?php echo $ct_id ?>"><?php echo $name ?></option>

                    <?php

                    $data = "SELECT * FROM district ORDER BY name ASC";
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <select name="dist_id" class="form-control select2" id="fetc_dist"
                    ...
                    $data = "SELECT * FROM districts ORDER BY name ASC";
              ...
              <div class="col-md-12 text-center text-primary">
                ...
                <?php
              $query2 = "SELECT  * FROM dependents  WHERE emp_id = '44444-4444444-4' ";
