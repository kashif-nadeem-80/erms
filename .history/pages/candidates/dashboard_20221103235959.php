                ...
                <div class="row">
                    ...
                    <div class="row col-md-12">
                                    ...
                                    <thead class="bg-gradient-cyan"  >
                                            <tr>
                                                <th class="w-25 ">Province</th>
                                                <th class="w-25">Name</th>
                                                <th class="W">Father Name</th>
                                                <th class="w-10">Department</th>
                                                <th class="w-10">Post Applied</th>
                                                <th class=" bg-gradient-green ">Result</th>
      ...
      $written_marks_r = $rowData_r['written_marks'];
       ...
       ?>
                                            ...
                                            <tr style="">
                                                ...
                                                <td class=" text-danger  text-bold text-font-weight-bolder"><?php echo $result_r."/".$written_marks_r; ?></td>
