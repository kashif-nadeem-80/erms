        ...
        <div class="card ">
            <div class="card-body  ">
                <div class="row">
                    ...
                    <p> <span style="font-size:x-large ; font-weight:bolder; color: black;"> Written Test Result </span>  </p>

                    <div class="row col-md-12 ">

                                    <hr class="shadow float-left" style="border: 1px solid #007bff; width: 100%; ">

                                    <table class="table-hover table-responsive table-striped table-bordered bg-white text-center align-content-center" 
