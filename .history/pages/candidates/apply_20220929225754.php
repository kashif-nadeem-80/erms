  ...
  <?php
    ...
    //  echo $canddate_id;
     //echo "Row NUm--" , $rowN;
      ...
      if ($rowN < 3 or $disability==0 and $gender==0 and is_null($dob) and is_null($city) and is_null($cellno) )
      // if ($rowN==0)
      {
            ...
            <tr>
              ...
              <td>
               ...
               <a style="margin-top: 2px"  href="post_apply.php?id=<?php echo $encodeId;?>&projId=<?php echo $enProjectId;?>"
                ...
                <a style="margin-top: 2px" href="<?php echo $adver ?>"  class="btn btn-warning btn-sm" target="_blank">Advertisement</a>
