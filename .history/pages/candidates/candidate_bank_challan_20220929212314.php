...
<div class="content-header">
 ...
 <section class="content printClr">
  <div class="row printBlock">
    <div class="col-md-12">
      <a href="posts_applied.php?id=<?php echo $projId_enc ?>" class="btn btn-warning shadow mb-1 ml-2">Back</a>
      <button class="btn btn-info float-right shadow mr-2" onclick="window.print();">Print</button>
    </div>
  </div>
  <div class="container-fluid">
              ...
              <tr>
                <td>
                  <div class="row ml-1">
                    ...
                    <div class="col-md-4">
                      <span><img height="50px" width="80px" src="../../images/admin/bank_logo.png/<?php echo $logo1 ?>" alt=""></span>
                    </div>
                  </div>
                  <div class="row ml-1">
                    <div class="col-md-12">
