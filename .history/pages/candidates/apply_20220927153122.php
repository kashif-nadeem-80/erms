...
<div class="m-0 card-header  bg-info shadow-lg p-1 mb-0 bg-primary text-danger rounded">
  ...
  <?php
     ...
     $query1 = "select count(*) from education WHERE candi_id = '$canddate_id'";
     
     $result1 = mysqli_query($connection,$query1);
     $rowN = mysqli_num_row($result1);
    //  $id_edu = $rowData1['id'];
    ...
    //  echo $city;
      ...
      if ($disability==0 and $gender==0 and is_null($dob) and is_null($city) and is_null($cellno) )
      {
        ...
        <html>
          ...
          Swal.fire(
            'Back !',
            'Please fill your bio data form and education',
            'warning'
          ).then((result) => {
