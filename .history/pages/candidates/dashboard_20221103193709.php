...
<div class="container">
      ...
      pw.`shorthand_marks`, pw.`shorthand_weightage`, c.`name`, c.`cnic`, 
       c.`telephone`,  r.roll_no, r.written_result,
      ...
      WHERE c.id='1045'
      ORDER BY (((r.written_result/pw.`written_marks`)*pw.`written_weightage`) + ((r.typing_result/pw.`typing_marks`)*pw.`typing_weightage`) 
      + ((r.shorthand_result/pw.`shorthand_marks`)*pw.`shorthand_weightage`)) 
      DESC, pp.post_name, ca.id ASC";
  ...
  // echo $countData_r;
      ...
      $city_r = $rowData_r['city'];
      $status_r = $rowData_r['status'];
      $name_r = $rowData_r['Name'];
      $father_name_r = $rowData_r['Father_Name'];
      $post_name_r = $rowData_r['post_name'];
      $department_r = $rowData_r['Department'];
      $status_detail_r = $rowData_r['status_details'];
