  ...
  <div class="container">
    <div class="card"> 
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
           <p> <span style="font-size:x-large ;">  How to Apply </span> <span style="align-items:center ;">   <a href="personal_information.php" style="width:230px ; align-items: center;" class="btn btn-info shadow" >Change Test City</a>  </span> </p> 
