  ...
  <div class="container-fluid">
    ...
    <div class="row mb-2">
      ...
      <div class="col-md-6 ">
        ...
        <h4 class="m-0">Change Your Test City</h4>
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                ...
                <div class="form-group">
                  ...
                  <label>Name & CNIC</label>

                  <select class="form-control" name="post" disabled required style="appearance: none;">

                    <!-- <option value="">Choose</option> -->

                    <?php

                    $query = "SELECT id,name,cnic FROM candidates WHERE id = '$canddate_id'";
                    ...
                    echo "<option value='$id'>$name  /  CNIC= ($cnic)</option>";
...
<div class="form-group">
                ...
                <label>Already Selected City</label>
                  <select class="form-control" name="post" required disabled style="appearance: none;" >
                  
                    <?php

                  $query = "SELECT a.cnic, a.name, b.c_name as city FROM candidates a, city b  WHERE  a.city= b.id and a.id = '$canddate_id'";
                    ...
                    echo "<option value='$id'>  $cityid </option>";
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <input style="width: 200px; " type="submit" class="btn btn-success shadow" value="Save "
              id="saveid" name="saveUser" > 
              <!-- <a style="width:150px ;" href="apply.php?id=<?php echo $proj_id ?>"  class="btn btn-success shadow btn-danger">Back</a> </p> -->
          ...
          $update = "INSERT INTO `candidate_applied_post`(`candidate_id`, `post_id`, `city_id`, `apply_date`) VALUES ('$canddate_id','$post','$test_city','$date')";
          ...
          <html>
            ...
            <body>
              ...
              window.location.href = 'dashboard.php?id=$projId_enc';
