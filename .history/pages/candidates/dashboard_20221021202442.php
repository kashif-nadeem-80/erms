                        ...
                        <div class="col-md-12 text-center text-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 table-responsive">
                                    ...
                                    <table class="table-hover table-responsive-lg table-bordered bg-white text-center table-responsive"
                                        style="font-size: 13px">

                                        <thead class="bg-gradient-teal embed-embed-responsive-item">
                                            <tr>
                                                <th>Status</th>
