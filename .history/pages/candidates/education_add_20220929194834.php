  ...
  <div class="container-fluid" class="text-center">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <span class="text-red font-weight-bold">Add educational record from lower level to higher level; e.g: Matric, Intermediate, Bachelor etc</span>
        <span class="text-danger ">If No " Course " then press "Next" to apply </span>
