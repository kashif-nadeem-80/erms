  ...
  <div class="container-fluid" class="text-center">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <p class="text-red font-weight-bold">Add educational record from lower level to higher level; e.g: Matric, Intermediate, Bachelor etc</p>
        <p class="text-red font-weight-bold">If No   <p style="color: red;"> " Course " </p> then press "Next" to apply </p>
