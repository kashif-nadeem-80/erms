                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select  style="appearance: none; font-weight: bold; font-style: oblique; font-size: 19px; " 
                        class="form-control border-0 bg-green  " name="level" id="levl"  onchange="getdegree1()" required>
