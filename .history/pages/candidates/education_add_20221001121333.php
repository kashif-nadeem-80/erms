  ...
  <div class="container-fluid" class="text-center">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <span class="text-red font-weight-bold">Add educational record from lower level to higher level; </span>
        <span class="  table-dark  ">If No  <span style=" font-weight:bolder ;"> " Certification "  </span> then press "Next" to apply </span>
                ...
                <form method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select disabled style="appearance: none; font-weight: bold; font-style: oblique; font-size: 19px; " 
                        class="form-control border-0 bg-green  " name="level" id="level"  onclick="getdegree1()" required>
                          <!-- <option value="">Select Option</option> -->
                          
                          <?php
                          $query = "SELECT * FROM education where candi_id='$canddate_id'";
                          $result = mysqli_query($connection,$query);
                          $rowN = mysqli_num_rows($result);
                           while ($rowEd = mysqli_fetch_array($result)) {
                           $edu_level = $rowEd['degree_id'];
                           }   
                          ...
                          ?>
                          <?php
                          $query = "SELECT * FROM edu_level where status=1 and id='$levelId'";
                          $result = mysqli_query($connection,$query);
                          ...
                          // echo "<option value='$l_id'>$rowN</option>"; 
                           }
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select id="degree" class="form-control level"  onfocus="getdegree()" name="degree" required>
                          <option value="">Select Option</option>
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <span class=" text-danger"> Input "0" in case of certification </span>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                  ...
                  <div class="row" >
                    ...
                    <div class="col-md-12 text-right align-content-center">
                      <input type="submit" class="btn btn-success shadow" style="width:230px ;" value="Save" name="saveUser1">
                      <!-- <input type="submit" class="btn btn-primary shadow" style="width:230px ;" value="Add & Next" name="saveUser2"> -->
                      <a href="apply.php" style="width:230px ;" class="btn btn-warning shadow" >Next</a>
                    </div>
