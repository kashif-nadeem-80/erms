            ...
            <div class="card-body">
                <!-- <div class="row"> -->
                    ...
                    Application Status </span> <span
                            ...
                            <img src="../../images/news1.gif" width="30px" height="30px"> <a href="posts_applied.php" style="width:150px ; align-items: center;"
                                class="btn  badge-pill badge-info shadow">Upload Challan</a>
                        </span> </p> 
       ...
       ?>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <span></span>  
                                                <b style="font-size: large; color: #007bff;"><?php echo $status_c?></b></td>
