            ...
            <div class="card-body">
                <!-- <div class="row"> -->
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-16 text-center align-content-center text-primary">
                    ...
                    <p style="align-content:center ;"> <span style="font-size:x-large ; font-weight:bolder; padding-right: 80px;">

                    Application Status </span> 


                                    <hr class="shadow float-left" style="border: 1px solid #007bff; width: 60%; ">
