  ...
  <div class="sidebar ">
    ...
    <nav class="mt-2  ">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="roll_no_slip.php" class="nav-link <?php if($curPageName == 'roll_no_slip.php' OR $curPageName == 'post_apply.php' OR $curPageName == 'candidate_bank_challan.php' ) echo "active" ?>">
