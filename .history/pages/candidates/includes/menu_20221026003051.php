      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item">
          <a href="dashboard.php" class="nav-link <?php if($curPageName == 'dashboard.php') echo "active" ?>">
            <i class="nav-icon fa-watchman-monitoring"></i>
            <p>Dashboard</p>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="roll_no_slip.php" class="nav-link <?php if($curPageName == 'roll_no_slip.php' OR $curPageName == 'roll_no_slip.php' OR $curPageName == 'candidate_bank_challan.php' ) echo "active" ?>">
