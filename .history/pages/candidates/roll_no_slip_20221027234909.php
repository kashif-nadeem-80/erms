    ...
    <section class="content myDivToPrint">
        <div class="row">
            <div class="col-md-12 mb-2">
             <a  href="dashboard.php" class=" btn btn-outline-info shadow "> Back </a>
                
                <button type="button" onclick="window.print()" class="printBlock btn btn-outline-warning shadow float-right">Print</button>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-cyan printBlock">
                        <div class="card-title">Roll No Slip</div>
                    </div>
                    <?php
