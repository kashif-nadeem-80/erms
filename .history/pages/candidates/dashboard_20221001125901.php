  ...
  <div class="container">
    <div class="card"> 
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
            <p> <spane style="font-size: 800px ;"> How to Apply  </spane> <a href="apply.php" style="width:230px ;" class="btn btn-warning shadow" >Next</a> </p>
            ...
            <ul><li>Add Your Employement Experience (if Any)</li> 
