                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select disabled style="appearance: none; font-size: 18px; font:18px; nav-down: current;" class="form-control border-0 bg-yellow  " name="level" id="levl"  onclick="getdegree()" required>
