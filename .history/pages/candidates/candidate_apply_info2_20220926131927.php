...
$query3 ="SELECT ca.id,p.post_name,p.post_bps,ca.apply_date,ca.status,ca.challan_file FROM candidate_applied_post AS ca INNER JOIN projects_posts AS p ON p.id = ca.post_id WHERE ca.candidate_id = '$canddate_id'";
