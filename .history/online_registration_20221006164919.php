        ...
        <div class="container" >
          <div class="card">
            <div class="card-body" >
              ...
              <p  style="margin-top: -10px; margin-bottom: 20px">Have an account Or <a href="#" class="fa-capsules" style="font-size:large; font-weight:bold ; color: red;" onclick="registDiv()"> Register Here </a> </p> 
