...
<html>
  ...
  <body style="padding-top: 70px; background: #e6e6e6; overflow-x: hidden; background-image: url(images/loginbg.jpg);">
    <div class="row  bg-gradient-olive " >
      <div class="col-md-1" style="margin-top: 1%;  text-shadow: 0 1 2px #0000FF; font-family: time new roman;" > ></div>
      <!-- <div class="col-md-7" > -->
        <img src="images/logo.png" width="70px" height="70px">   <h3 style="color: #FFFFFF; font-weight: bolder" class="progress-bar-animated" >Universal Testing Services</h3>
      </div>
