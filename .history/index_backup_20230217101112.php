            ...
            ?>
                            ...
                            <!-- <tr>
                                ...
                                <td colspan="3" class="text-center font-weight-bold text-danger"><===No Post to
                                    ...
                                    <a href="index.php" style="width:170px ; align-items: center;"
                            ...
                            <td colspan="3" class="text-center font-weight-bold text-danger">
                                <!-- <===No Post to
                                    Apply ===> -->
                                    <br>
                                    <img src="./images/news1.gif" width="35px" height="35px">  
                                    FFBL, FPCL & FML Apprenticeship Program Candidates Result &nbsp;&nbsp;&nbsp;
                                    <a href="online_registration.php" style="width:170px ; align-items: center;"
                                class="btn  badge-pill  badge-info shadow">Click for Result </a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="text-center font-weight-bold text-danger">
                                  ...
                                  FFBL, FPCL & FML Apprenticeship Program Candidates can download "Answer Key" &nbsp;&nbsp;&nbsp;
                                    <a href="./images/key/FFBL-FML-FPCL-Answer-Key.pdf" style="width:150px ; align-items: center;"
                                class="btn  badge-pill badge-success shadow">Download Key</a>
                                </td>
