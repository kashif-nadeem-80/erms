  ...
  <body style="padding-top: 70px; background: #e6e6e6; overflow-x: hidden; background-image: url(images/loginbg.jpg);">
    <div class="row  bg-gradient-olive " >
      ...
      <div class="col-md-10  text-black-50"
        ...
        <h3 style="color: #e6e6e6; font-weight: bolder; ">Universal Testing Services</h3>
      </div>
    </div>
    <br>
            ...
            <div class="card-body" >
              ...
              <form method="post" id="register_form">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <input style="width:40px ;" type="submit" name="login" class="btn btn-info shadow" value="Sign In">
                    </div>
                  </div>
                  <div class="col-md-1"></div>
                </div>
