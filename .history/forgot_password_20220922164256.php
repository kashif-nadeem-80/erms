...
<html>
  <head>
    ...
    <title>UTS | Forgot Password</title>
  ...
  <body style="background: #e6e6e6; overflow-x: hidden;">
    ...
    <div class="row bg-white">
      ...
      <div class="col-md-10 text-left" style="margin-top: 1%; text-shadow: 0 1 2px #0000FF; font-family: time new roman"><h3>Universal Testing Services</h3></div>
    </div>
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="form-group">
                      ...
                      <p class="text-primary mt-2">Password will be send to registered email</p>
                    </div>
                  </div>
                  <div class="col-md-5">
                    <br>
      ...
      <div class="col-md-8">
        <div class="container">
          <div class="card shadow" style='border: 1px solid blue'>
            ...
            <div class="card-body">
              <p><span class="text-primary"><i class="fa fa-phone"></i></span> 051-111258369<b>,</b> 051-2152815<b>,</b> 051-2100749</p>

              <p><span class="text-primary"><i class="fa fa-envelope"></i></span> info@uts.com.pk</p>
              <p></p>
            </div>
          </div>
        </div>
