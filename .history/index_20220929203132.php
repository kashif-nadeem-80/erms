...
<html lang="en">
  ...
  <body style="background: #E6E6E6">
    ...
    <div class="container-fluid  align-content-center" style="padding-left:10px ; ">
    <div class="row">

<div class="col-md-12 table-responsive align-content-center">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a style="margin-top: 2px" href="online_registration.php?id=<?php echo $encodeId; ?>"
