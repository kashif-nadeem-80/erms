    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a style="margin-top: 0px" href="online_registration.php?id=<?php echo $encodeId; ?>"

          class="btn btn-success btn-sm">Online Apply</a>

          <a style="margin-top: 0px" href="<?php echo $adver ?>" class="btn btn-warning btn-sm" target="_blank">Advertisement</a>
     ...
     <?php //echo "this is ...";  echo $adver;
            ...
            <tr>
              ...
              <td colspan="3" class="text-center font-weight-bold text-danger">No Post Available For Apply 
               <br>
              FFBL, FPCL & FML Apprenticeship Program Candidates have to wait for the Accepted / Rejected List.
